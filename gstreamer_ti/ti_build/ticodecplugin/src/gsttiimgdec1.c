 ...
 * gsttiimgdec1.c
 *
 * This file defines the "TIImgdec1" element, which decodes a JPEG image
 *
 * Example usage:
...
static gboolean gst_tiimgdec1_codec_start (GstTIImgdec1  *imgdec1)
{
    ...
    gfxAttrs.colorSpace     = gst_tiimgenc1_codec_color_space_to_dmai(imgdec1->params.forceChromaFormat);
