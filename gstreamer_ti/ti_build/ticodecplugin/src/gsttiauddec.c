...
static void gst_tiauddec_init(GstTIAuddec *auddec, GstTIAuddecClass *gclass)
{
    ...
    gst_pad_set_getcaps_function(
        auddec->sinkpad, GST_DEBUG_FUNCPTR(gst_pad_proxy_getcaps));
    ...
    gst_pad_set_getcaps_function(
        auddec->srcpad, GST_DEBUG_FUNCPTR(gst_pad_proxy_getcaps));
...
static gboolean gst_tiauddec_init_audio(GstTIAuddec * auddec)
{
    ...
    auddec->circBuf = gst_ticircbuffer_new(Adec_getInBufSize(auddec->hAd) * 10);
...
static void gst_tiauddec_broadcast_queue_thread(GstTIAuddec *auddec)
{
    ...
    Rendezvous_forceAndReset(auddec->waitOnQueueThread);
}
